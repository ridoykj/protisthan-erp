...
// import { AutoGridRef } from '@vaadin/hilla-react-crud';
...
//   const itemSelect = useSignal<string>('');
...
//                 //   },
//                 // };
//                 // ItemDtoCrudService.list(pagination, filters).then((result: any) => {
//                 //   if (result.length !== 0) {
//                 //     addToCart.value = [...addToCart.value, result];
//                 //     itemSelect.value = '';
//                 //   }
//                 // });
//                 ItemDtoCrudService.getItem(itemSelect.value).then((result) => {
//                   if (result) {
//                     addToCart.value = [...addToCart.value, result];
//                     itemSelect.value = '';
//                   }
